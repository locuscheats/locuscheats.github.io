...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'steam',
                link: 'https://steamcommunity.com/id/DonkeyRUST'
            },

		    {
                name: 'discord',
                link: 'https://discord.com/users/586684223834947594/'
            },
		    {
                name: 'discord server',
                link: 'https://discord.gg/akirax'
            },
                    {
                name: 'v3rmillion',
                link: 'https://v3rmillion.net/member.php?action=profile&uid=2682194'
            },
		    {
                name: 'ogusers',
                link: 'https://ogu.gg/LocusModz'
            },	   
		
		    {
                name: 'youtube',
                link: 'https://www.youtube.com/channel/UCLHebnEDcgwiuEO6E4MkwAA'
            },
		    {
                name: 'roblox',
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Starting... Intializing.", "Trying to connect to <span style='font-size: 14px; color: #7F00FF;'>[locuscheats]</span>..."], 30, function () {
